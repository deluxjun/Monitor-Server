 ...
 */
public class TcpClient_RequestSetAgent extends IoHandlerAdapter {
    /** The connector */
     ...
     */
    public TcpClient_RequestSetAgent() {
...
//(0x00000003: nio socket, server, /127.0.0.1:35969 => /127.0.0.1:18880)
    ...
    public static void main(String[] args) throws Exception {
        TcpClient_RequestSetAgent client = new TcpClient_RequestSetAgent();
        ...
        joSub.put("Command", 	"Set_EnvProperties_Main"); //Trans_Unit_Inquiry
        jj.put("PropertyNames", "AggregateDb_Expire_ResourceMin"); //Trans_Unit_Inquiry
        
        joSub.put("AggregateDb_Expire_ResourceMin", 	"2009");
