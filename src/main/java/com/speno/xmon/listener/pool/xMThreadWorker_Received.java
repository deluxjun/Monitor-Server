...
public abstract class xMThreadWorker_Received extends Thread{
	...
	public xMThreadWorker_Received(int processorID) throws Exception 
	{
	...
	public xMThreadWorker_Received() {
		workerName = "*PoolReceived";
	}
