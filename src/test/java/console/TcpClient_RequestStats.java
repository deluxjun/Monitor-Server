 ...
 */
public class TcpClient_RequestStats extends IoHandlerAdapter {
    /** The connector */
...
//(0x00000003: nio socket, server, /127.0.0.1:35969 => /127.0.0.1:18880)
    ...
    public static void main(String[] args) throws Exception {
        TcpClient_RequestStats client = new TcpClient_RequestStats();
        ...
        joSub.put("AggreUnit", 	"Avg"); //,Min, Max
        joSub.put("PerUnit", 	"Min");
        joSub.put("RangeStart", "2014-07-31 09:05");
        joSub.put("RangeEnd", 	"2014-07-31 09:30");
        ja.put(joSub);
