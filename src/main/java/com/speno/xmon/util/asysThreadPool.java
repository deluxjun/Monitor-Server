...
public class asysThreadPool<T extends asysThreadWorker> {
	...
	public asysThreadPool() throws Exception {
		this(poolSize, maxPoolSize);
	}
	
	@SuppressWarnings("unchecked")
	public asysThreadPool(int size, int maxSize) throws Exception{
		poolSize = size;
		maxPoolSize = maxSize;
	}
