...
public abstract class xMThreadWorker_Action extends Thread{
	...
	public xMThreadWorker_Action(int processorID) throws Exception 
	{
	...
	public xMThreadWorker_Action() {
		workerName = "*PoolAction";
	}
