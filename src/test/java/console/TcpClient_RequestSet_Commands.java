 ...
 */
public class TcpClient_RequestSet_Commands extends IoHandlerAdapter {
    /** The connector */
     ...
     */
    public TcpClient_RequestSet_Commands() {
...
//(0x00000003: nio socket, server, /127.0.0.1:35969 => /127.0.0.1:18880)
    ...
    public static void main(String[] args) throws Exception {
        TcpClient_RequestSet_Commands client = new TcpClient_RequestSet_Commands();
