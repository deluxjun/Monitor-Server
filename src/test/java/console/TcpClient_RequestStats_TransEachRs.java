 ...
 */
public class TcpClient_RequestStats_TransEachRs extends IoHandlerAdapter {
    /** The connector */
     ...
     */
    public TcpClient_RequestStats_TransEachRs() {
...
//(0x00000003: nio socket, server, /127.0.0.1:35969 => /127.0.0.1:18880)
    ...
    public static void main(String[] args) throws Exception {
        TcpClient_RequestStats_TransEachRs client = new TcpClient_RequestStats_TransEachRs();
        ...
        joSub.put("Command", 	"Trans_Unit_DbConn"); //Trans_Unit_Inquiry
