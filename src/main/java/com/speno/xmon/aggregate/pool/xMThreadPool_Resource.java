...
public class xMThreadPool_Resource<T extends xMThreadWorker_Resource> {
	...
	public xMThreadPool_Resource() throws Exception {
		this(poolSize, maxPoolSize);
	}
	
	public xMThreadPool_Resource(int size, int maxSize) throws Exception{
		poolSize = size;
		maxPoolSize = maxSize;
	}
