...
public class xMThreadPool_Expire<T extends xMThreadWorker_Expire> {
	...
	public xMThreadPool_Expire() throws Exception {
		this(poolSize, maxPoolSize);
	}
	
	public xMThreadPool_Expire(int size, int maxSize) throws Exception{
		poolSize = size;
		maxPoolSize = maxSize;
	}
