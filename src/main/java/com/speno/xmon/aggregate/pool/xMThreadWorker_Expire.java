...
public abstract class xMThreadWorker_Expire extends Thread{
	...
	public xMThreadWorker_Expire(int processorID) throws Exception 
	{
	...
	public xMThreadWorker_Expire() {
		workerName = "*PoolExpire";
	}
