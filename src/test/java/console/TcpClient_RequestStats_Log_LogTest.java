 ...
 */
public class TcpClient_RequestStats_Log_LogTest extends IoHandlerAdapter {
    /** The connector */
     ...
     */
    public TcpClient_RequestStats_Log_LogTest() {
    ...
    public TcpClient_RequestStats_Log_LogTest(IoSession session2) {
    ...
    public static void main(String[] args) throws Exception {
    	//TcpClient_RequestSet_InitSession c = new TcpClient_RequestSet_InitSession();
    	
        TcpClient_RequestStats_Log_LogTest client = new TcpClient_RequestStats_Log_LogTest();
