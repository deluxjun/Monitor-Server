 ...
 */
public class TcpClient_RequestSet_AgentHealth extends IoHandlerAdapter {
    /** The connector */
     ...
     */
    public TcpClient_RequestSet_AgentHealth() {
...
//(0x00000003: nio socket, server, /127.0.0.1:35969 => /127.0.0.1:18880)
    ...
    public static void main(String[] args) throws Exception {
        TcpClient_RequestSet_AgentHealth client = new TcpClient_RequestSet_AgentHealth();
        ...
        jj.put("Command", 	"Set_AgentHealth"); //Trans_Unit_Inquiry
