...
public class xMThreadPool_AmassReceived<T extends xMThreadWorker_AmassReceived> {
	...
	public xMThreadPool_AmassReceived() throws Exception {
		this(poolSize, maxPoolSize);
	}
	
	public xMThreadPool_AmassReceived(int size, int maxSize) throws Exception{
		poolSize = size;
		maxPoolSize = maxSize;
	}
