...
public abstract class xMThreadWorker_AmassReceived extends Thread{
	...
	public xMThreadWorker_AmassReceived(int processorID) throws Exception 
	{
	...
	public xMThreadWorker_AmassReceived() {
		workerName = "*PoolAmassReceived";
	}
